                ...
                <div className="prose prose-[#C17F24] max-w-none text-[#5A5A5A] text-sm leading-relaxed space-y-12">
                    <section>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-amber-50/50 p-6 rounded-2xl border border-amber-100/50 space-y-3">
                                <p className="font-semibold text-[#2E2E2E]">Eligibility for Return or Exchange:</p>
                                <ul className="list-disc pl-5 space-y-2">
                                    ...
                                    <li>Only defective or damaged items are replaced based on an exchange request.</li>
                                </ul>
                            </div>

                            <p className="text-xs text-[#8E562E] italic">Note: Certain categories of products / items are exempted from returns or refunds. Such categories will be identified to you at the time of purchase.</p>
                            ...
                            <p>If the same has been approved after the quality check at our end, your request will be processed in accordance with our policies.</p>
                        </div>
                    </section>
                </div>
            </div>
