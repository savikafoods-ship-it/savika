                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            ...
                            <ul className="list-disc pl-5 space-y-3">
                                ...
                                <li><strong>Perishable Items:</strong> Savika Foods does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good.</li>
                                <li><strong>Damaged/Defective Items:</strong> In case of receipt of damaged or defective items, please report to our customer service team. The request would be entertained once the seller/ merchant listed on the Platform, has checked and determined the same at its own end. This should be reported within 2 days of receipt of products.</li>
                                <li><strong>Expectation Mismatch:</strong> In case you feel that the product received is not as shown on the site or as per your expectations, you must bring it to the notice of our customer service within 2 days of receiving the product. The customer service team after looking into your complaint will take an appropriate decision.</li>
                                ...
                                <li><strong>Refund Processing:</strong> In case of any refunds approved by Savika Foods, it will take 2 days for the refund to be processed to you.</li>
                            </ul>
                        </div>
                    </section>
                </div>
